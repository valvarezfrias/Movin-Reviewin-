...
def userInfoApiRequest(inputCity, inputOcup):
    url = 'https://api.bls.gov/publicAPI/v1/timeseries/data/OEUM00' +
    inputCity + '000000' + inputOcup + '03'  # occupation and salary
    # R is a dictionary
...
def randomIndex(userInputCity, userInputOccupation, vdf):
    ...
    flag = False
    while flag is False:
        if vdf.at[randomInt, 'city'] != userInputCity
        and vdf.at[randomInt, 'occupation'] == userInputOccupation:
